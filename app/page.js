...
const ORBS = [
  ...
  { x: "70%",  y: "18%", w: 360, c: "rgba(236,72,153,0.11)" },
  { x: "5%",   y: "42%", w: 320, c: "rgba(139,92,246,0.12)" },
  { x: "80%",  y: "50%", w: 400, c: "rgba(236,72,153,0.09)" },
  { x: "40%",  y: "68%", w: 500, c: "rgba(124,58,237,0.13)" },
  { x: "10%",  y: "80%", w: 340, c: "rgba(167,139,250,0.10)" },
  { x: "75%",  y: "88%", w: 380, c: "rgba(236,72,153,0.10)" },
];
...
// Uses viewport-relative clientPos so it works everywhere on the page.
  ...
  return (
    ...
    >
      <div className={`relative rounded-2xl ${innerBg} h-full overflow-hidden`}>
        {/* Inner glow fill on spotlight */}
        <div
          className="absolute inset-0 pointer-events-none rounded-2xl"
          style={{
            background: `radial-gradient(200px circle at ${rx}px ${ry}px,
              rgba(124,58,237,0.06), transparent 70%)`,
          }}
        />
        {children}
      </div>
...
export default function LandingPage() {
  ...
  // Single global mouse state — uses clientX/Y (viewport coords)
  // so it works correctly even as the user scrolls.
  ...
  return (
    ...
    >
      {/* ── Global fixed spotlight (follows cursor across all sections) ── */}
      <div
      ...
      {/* ── Full-page background: stars + orbs + dot grid ─────────── */}
      ...
      {/* ════════════════════════════════════════════════════════════
          FEATURES SHOWCASE — spotlight cards
      ════════════════════════════════════════════════════════════ */}
      <section id="features" className="relative z-20 px-6 py-20 max-w-6xl mx-auto">
        <FadeIn className="text-center mb-12">
          ...
          <p className="text-xs text-purple-400/60 mt-4 tracking-wide">Move your cursor over the cards</p>
        </FadeIn>
